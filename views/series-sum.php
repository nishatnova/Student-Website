            ...
            <div class="col-md-7 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center">Series Sum</h4>
                    </div>
                    <div class="card-body">
                        <form action="action.php" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <textarea cols="30" rows="5" class="form-control"> <?php echo isset($_GET['result']) ? base64_decode($_GET['result']) : ''; ?> </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" class="btn btn-success rounded-0 px-5"  name="series_sum_btn" value="Show Result"/>
                                </div>
                            </div>
